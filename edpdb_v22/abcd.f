...
1002	format('!doit>',i6,' atoms included')
	...
	fk=1./float(k)
	write( 6,1001) 'x',sum_x*fk,min_x,max_x,max_x-min_x,
     1         'y',sum_y*fk,min_y,max_y,max_y-min_y,
	...
	write(48,1001) 'x',sum_x*fk,min_x,max_x,max_x-min_x,
     1         'y',sum_y*fk,min_y,max_y,max_y-min_y,
     1         'z',sum_z*fk,min_z,max_z,max_z-min_z,
     1 sqrt(max((rms_r-(sum_x*sum_x+sum_y*sum_y+sum_z*sum_z)*fk)*fk,0.)),
     1 sqrt(rms_r*fk),
     ...
     1         'b',sum_b*fk,min_b,max_b,max_b-min_b,
     1 sqrt(max((rms_b-sum_b*sum_b*fk)*fk,0.))
1001	format('!',15x,'aver.',6x,'min.',6x,'max.',5x,'range',
     1 2x,'sgm(r,b)',4x,'rms(r,w)',
     1 2(/'!',9x,a1,4f10.3),2(/'!',9x,a1,6f10.3/'!',9x,a1,4f10.3,10x,f10.3))
